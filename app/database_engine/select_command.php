...
abstract class BaseSelectCommand extends EngCommand implements IFilterable {
    ...
    protected final function hasDistincts() {
        return count($this->distincts) > 0;
    }
...
class CustomSelectCommand extends BaseSelectCommand {
    ...
    public function GetSQL() {
        if ($this->HasCondition() || $this->HasJoins() || $this->HasOrdering() || $this->hasGroupBy() || $this->hasDistincts()) {
