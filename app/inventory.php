 ...
 */
    ...
    class inventory_inventory_loans_conditionPage extends DetailPage
    {
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Item_Description_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            //
            $column = new BlobImageViewColumn('Photo', 'Photo', 'Photo', $this->dataset, true, 'DetailGridinventory.inventory_loans_condition_Photo_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Completeness_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            
            //
            // View column for Completeness_Photo field
            //
            $column = new BlobImageViewColumn('Completeness_Photo', 'Completeness_Photo', 'Completeness Photo', $this->dataset, true, 'DetailGridinventory.inventory_loans_condition_Completeness_Photo_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Remark_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Item_Description_handler_print');
            $grid->AddPrintColumn($column);
            ...
            // View column for Photo field
            //
            $column = new BlobImageViewColumn('Photo', 'Photo', 'Photo', $this->dataset, true, 'DetailGridinventory.inventory_loans_condition_Photo_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Completeness_handler_print');
            $grid->AddPrintColumn($column);
            
            //
            // View column for Completeness_Photo field
            //
            $column = new BlobImageViewColumn('Completeness_Photo', 'Completeness_Photo', 'Completeness Photo', $this->dataset, true, 'DetailGridinventory.inventory_loans_condition_Completeness_Photo_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Remark_handler_print');
            $grid->AddPrintColumn($column);
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Item_Description_handler_export');
            $grid->AddExportColumn($column);
            ...
            // View column for Photo field
            //
            $column = new BlobImageViewColumn('Photo', 'Photo', 'Photo', $this->dataset, true, 'DetailGridinventory.inventory_loans_condition_Photo_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Completeness_handler_export');
            $grid->AddExportColumn($column);
            
            //
            // View column for Completeness_Photo field
            //
            $column = new BlobImageViewColumn('Completeness_Photo', 'Completeness_Photo', 'Completeness Photo', $this->dataset, true, 'DetailGridinventory.inventory_loans_condition_Completeness_Photo_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Remark_handler_export');
            $grid->AddExportColumn($column);
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Item_Description_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            // View column for Photo field
            //
            $column = new BlobImageViewColumn('Photo', 'Photo', 'Photo', $this->dataset, true, 'DetailGridinventory.inventory_loans_condition_Photo_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Completeness_handler_compare');
            $grid->AddCompareColumn($column);
            
            //
            // View column for Completeness_Photo field
            //
            $column = new BlobImageViewColumn('Completeness_Photo', 'Completeness_Photo', 'Completeness Photo', $this->dataset, true, 'DetailGridinventory.inventory_loans_condition_Completeness_Photo_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.inventory_loans_condition_Remark_handler_compare');
            $grid->AddCompareColumn($column);
        ...
        protected function doRegisterHandlers() {
            ...
            $column = new TextViewColumn('Item_Description', 'Item_Description', 'Item Description', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.inventory_loans_condition_Item_Description_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Photo', 'DetailGridinventory.inventory_loans_condition_Photo_handler_print', new ImageFitByWidthResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Completeness field
            //
            $column = new TextViewColumn('Completeness', 'Completeness', 'Completeness', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.inventory_loans_condition_Completeness_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Completeness_Photo', 'DetailGridinventory.inventory_loans_condition_Completeness_Photo_handler_print', new ImageFitByWidthResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Remark field
            //
            $column = new TextViewColumn('Remark', 'Remark', 'Remark', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.inventory_loans_condition_Remark_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Item_Description field
            //
            $column = new TextViewColumn('Item_Description', 'Item_Description', 'Item Description', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.inventory_loans_condition_Item_Description_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Photo', 'DetailGridinventory.inventory_loans_condition_Photo_handler_compare', new ImageFitByWidthResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Completeness field
            //
            $column = new TextViewColumn('Completeness', 'Completeness', 'Completeness', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.inventory_loans_condition_Completeness_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Completeness_Photo', 'DetailGridinventory.inventory_loans_condition_Completeness_Photo_handler_compare', new ImageFitByWidthResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Remark field
            //
            $column = new TextViewColumn('Remark', 'Remark', 'Remark', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.inventory_loans_condition_Remark_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('Item_Description', 'Item_Description', 'Item Description', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.inventory_loans_condition_Item_Description_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Photo', 'DetailGridinventory.inventory_loans_condition_Photo_handler_view', new ImageFitByWidthResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Completeness field
            //
            $column = new TextViewColumn('Completeness', 'Completeness', 'Completeness', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.inventory_loans_condition_Completeness_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Completeness_Photo', 'DetailGridinventory.inventory_loans_condition_Completeness_Photo_handler_view', new ImageFitByWidthResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Remark field
            //
            $column = new TextViewColumn('Remark', 'Remark', 'Remark', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.inventory_loans_condition_Remark_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class inventory_borrowed_inventoryPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Borrower_ID_displayName_handler_list');
            $column->setHrefTemplate('worker.php?operation=view&pk0=%Borrower_ID%');
            $column->setTarget('_blank');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Purposed_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Location_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Completeness_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            //
            $column = new BlobImageViewColumn('Borrowed_Photo', 'Borrowed_Photo', 'Borrowed Photo', $this->dataset, true, 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_list');
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Remark_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Borrower_ID_displayName_handler_view');
            $column->setHrefTemplate('worker.php?operation=view&pk0=%Borrower_ID%');
            $column->setTarget('_blank');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Purposed_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Location_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Completeness_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            
            //
            // View column for Borrowed_Photo field
            //
            $column = new BlobImageViewColumn('Borrowed_Photo', 'Borrowed_Photo', 'Borrowed Photo', $this->dataset, true, 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_view');
            $column->SetEnablePictureZoom(false);
            $column->setHrefTemplate('borrowed_inventory.php?hname=borrowed_inventoryGrid_Borrowed_Photo_handler_list&large=1&pk0=%Borrowed_ID%');
            $column->setTarget('_blank');
            $grid->AddSingleRecordViewColumn($column);
            ...
            //
            $column = new BlobImageViewColumn('Agreement_Letter', 'Agreement_Letter', 'Agreement Letter', $this->dataset, true, 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_view');
            $column->SetEnablePictureZoom(false);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Remark_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            // Edit column for Inventory_ID field
            //
            $editor = new ComboBox('inventory_id_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'Inventory_ID', 
                $editor, 
                $this->dataset, 'Inventory_ID', 'displayName', $lookupDataset);
            ...
            $editColumn = new FileUploadingColumn('Borrowed Photo', 'Borrowed_Photo', $editor, $this->dataset, false, false, 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_edit');
            ...
            $editor->SetShowImage(true);
            $editor->setAcceptableFileTypes('image/*');
            $editColumn = new FileUploadingColumn('Agreement Letter', 'Agreement_Letter', $editor, $this->dataset, false, false, 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_edit');
            $editColumn->SetFileSizeCheckMode(true, 4125696);
            $editColumn->SetImageFilter(new NullFilter());
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $editor->SetShowImage(true);
            $editor->setAcceptableFileTypes('image/*');
            $editColumn = new FileUploadingColumn('Borrowed Photo', 'Borrowed_Photo', $editor, $this->dataset, false, false, 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_insert');
            $editColumn->SetFileSizeCheckMode(true, 4125696);
            $editColumn->SetImageFilter(new NullFilter());
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            ...
            $editor->SetShowImage(true);
            $editor->setAcceptableFileTypes('image/*');
            $editColumn = new FileUploadingColumn('Agreement Letter', 'Agreement_Letter', $editor, $this->dataset, false, false, 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_insert');
            $editColumn->SetFileSizeCheckMode(true, 4125696);
            $editColumn->SetImageFilter(new NullFilter());
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Borrower_ID_displayName_handler_print');
            $column->setHrefTemplate('worker.php?operation=view&pk0=%Borrower_ID%');
            $column->setTarget('_blank');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Purposed_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Location_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Completeness_handler_print');
            $grid->AddPrintColumn($column);
            
            //
            // View column for Borrowed_Photo field
            //
            $column = new BlobImageViewColumn('Borrowed_Photo', 'Borrowed_Photo', 'Borrowed Photo', $this->dataset, true, 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_print');
            $column->SetEnablePictureZoom(false);
            $column->setHrefTemplate('borrowed_inventory.php?hname=borrowed_inventoryGrid_Borrowed_Photo_handler_list&large=1&pk0=%Borrowed_ID%');
            $column->setTarget('_blank');
            $grid->AddPrintColumn($column);
            ...
            // View column for Agreement_Letter field
            //
            $column = new BlobImageViewColumn('Agreement_Letter', 'Agreement_Letter', 'Agreement Letter', $this->dataset, true, 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_print');
            $column->SetEnablePictureZoom(false);
            $column->setHrefTemplate('borrowed_inventory.php?hname=borrowed_inventoryGrid_Agreement_Letter_handler_view&large=1&pk0=%Borrowed_ID%');
            $column->setTarget('_blank');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Remark_handler_print');
            $grid->AddPrintColumn($column);
        }
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Borrower_ID_displayName_handler_export');
            $column->setHrefTemplate('worker.php?operation=view&pk0=%Borrower_ID%');
            $column->setTarget('_blank');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Purposed_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Location_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Completeness_handler_export');
            $grid->AddExportColumn($column);
            
            //
            // View column for Borrowed_Photo field
            //
            $column = new BlobImageViewColumn('Borrowed_Photo', 'Borrowed_Photo', 'Borrowed Photo', $this->dataset, true, 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_export');
            $column->SetEnablePictureZoom(false);
            $column->setHrefTemplate('borrowed_inventory.php?hname=borrowed_inventoryGrid_Borrowed_Photo_handler_list&large=1&pk0=%Borrowed_ID%');
            $column->setTarget('_blank');
            $grid->AddExportColumn($column);
            ...
            // View column for Agreement_Letter field
            //
            $column = new BlobImageViewColumn('Agreement_Letter', 'Agreement_Letter', 'Agreement Letter', $this->dataset, true, 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_export');
            $column->SetEnablePictureZoom(false);
            $column->setHrefTemplate('borrowed_inventory.php?hname=borrowed_inventoryGrid_Agreement_Letter_handler_view&large=1&pk0=%Borrowed_ID%');
            $column->setTarget('_blank');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Remark_handler_export');
            $grid->AddExportColumn($column);
        }
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Borrower_ID_displayName_handler_compare');
            $column->setHrefTemplate('worker.php?operation=view&pk0=%Borrower_ID%');
            $column->setTarget('_blank');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Purposed_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Location_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Completeness_handler_compare');
            $grid->AddCompareColumn($column);
            
            //
            // View column for Borrowed_Photo field
            //
            $column = new BlobImageViewColumn('Borrowed_Photo', 'Borrowed_Photo', 'Borrowed Photo', $this->dataset, true, 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_compare');
            $column->SetEnablePictureZoom(false);
            $column->setHrefTemplate('borrowed_inventory.php?hname=borrowed_inventoryGrid_Borrowed_Photo_handler_list&large=1&pk0=%Borrowed_ID%');
            $column->setTarget('_blank');
            $grid->AddCompareColumn($column);
            ...
            // View column for Agreement_Letter field
            //
            $column = new BlobImageViewColumn('Agreement_Letter', 'Agreement_Letter', 'Agreement Letter', $this->dataset, true, 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_compare');
            $column->SetEnablePictureZoom(false);
            $column->setHrefTemplate('borrowed_inventory.php?hname=borrowed_inventoryGrid_Agreement_Letter_handler_view&large=1&pk0=%Borrowed_ID%');
            $column->setTarget('_blank');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('DetailGridinventory.borrowed_inventory_Remark_handler_compare');
            $grid->AddCompareColumn($column);
        }
        ...
        protected function doRegisterHandlers() {
            ...
            $column->setHrefTemplate('worker.php?operation=view&pk0=%Borrower_ID%');
            $column->setTarget('_blank');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Borrower_ID_displayName_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Purposed field
            //
            $column = new TextViewColumn('Purposed', 'Purposed', 'Purposed', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Purposed_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Location field
            //
            $column = new TextViewColumn('Location', 'Location', 'Location', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Location_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Completeness field
            //
            $column = new TextViewColumn('Completeness', 'Completeness', 'Completeness', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Completeness_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Borrowed_Photo', 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_list', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Remark field
            //
            $column = new TextViewColumn('Remark', 'Remark', 'Remark', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Remark_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for displayName field
            //
            $column = new TextViewColumn('Borrower_ID', 'Borrower_ID_displayName', 'Borrower ID', $this->dataset);
            ...
            $column->setHrefTemplate('worker.php?operation=view&pk0=%Borrower_ID%');
            $column->setTarget('_blank');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Borrower_ID_displayName_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Purposed field
            //
            $column = new TextViewColumn('Purposed', 'Purposed', 'Purposed', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Purposed_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Location field
            //
            $column = new TextViewColumn('Location', 'Location', 'Location', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Location_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Completeness field
            //
            $column = new TextViewColumn('Completeness', 'Completeness', 'Completeness', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Completeness_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Borrowed_Photo', 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_print', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Agreement_Letter', 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_print', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Remark field
            //
            $column = new TextViewColumn('Remark', 'Remark', 'Remark', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Remark_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for displayName field
            //
            $column = new TextViewColumn('Borrower_ID', 'Borrower_ID_displayName', 'Borrower ID', $this->dataset);
            ...
            $column->setHrefTemplate('worker.php?operation=view&pk0=%Borrower_ID%');
            $column->setTarget('_blank');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Borrower_ID_displayName_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Purposed field
            //
            $column = new TextViewColumn('Purposed', 'Purposed', 'Purposed', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Purposed_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Location field
            //
            $column = new TextViewColumn('Location', 'Location', 'Location', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Location_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Completeness field
            //
            $column = new TextViewColumn('Completeness', 'Completeness', 'Completeness', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Completeness_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Borrowed_Photo', 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_compare', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Agreement_Letter', 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_compare', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Remark field
            //
            $column = new TextViewColumn('Remark', 'Remark', 'Remark', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Remark_handler_compare', $column);
            ...
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Borrowed_Photo', 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_insert', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Agreement_Letter', 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_insert', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
            $selectQuery = 'select w.`KTP/ID`, concat (w.Staff_Name,\' (\',w.`KTP/ID`,\')\') as displayName from worker as w';
            $insertQuery = array();
            $updateQuery = array();
            ...
            $lookupDataset->setOrderByField('displayName', GetOrderTypeAsSQL(otAscending));
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), ''));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_Inventory_ID_displayName_search', 'Inventory_ID', 'displayName', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for displayName field
            //
            $column = new TextViewColumn('Borrower_ID', 'Borrower_ID_displayName', 'Borrower ID', $this->dataset);
            ...
            $column->setHrefTemplate('worker.php?operation=view&pk0=%Borrower_ID%');
            $column->setTarget('_blank');
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Borrower_ID_displayName_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Purposed field
            //
            $column = new TextViewColumn('Purposed', 'Purposed', 'Purposed', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Purposed_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Location field
            //
            $column = new TextViewColumn('Location', 'Location', 'Location', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Location_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Completeness field
            //
            $column = new TextViewColumn('Completeness', 'Completeness', 'Completeness', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Completeness_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Borrowed_Photo', 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_view', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Agreement_Letter', 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_view', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Remark field
            //
            $column = new TextViewColumn('Remark', 'Remark', 'Remark', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'DetailGridinventory.borrowed_inventory_Remark_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);$selectQuery = 'select w.`KTP/ID`, concat (w.Staff_Name,\' (\',w.`KTP/ID`,\')\') as displayName from worker as w';
            $insertQuery = array();
            $updateQuery = array();
            $deleteQuery = array();
            ...
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Borrowed_Photo', 'DetailGridinventory.borrowed_inventory_Borrowed_Photo_handler_edit', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Agreement_Letter', 'DetailGridinventory.borrowed_inventory_Agreement_Letter_handler_edit', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class inventoryPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionSetForDataSource('inventory.inventory_loans_condition')->HasViewGrant() && $withDetails)
            {
            //
            // View column for inventory_inventory_loans_condition detail
            //
            $column = new DetailColumn(array('Inventory_ID'), 'inventory.inventory_loans_condition', 'inventory_inventory_loans_condition_handler', $this->dataset, 'Inventory Loans Condition');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            
            if (GetCurrentUserPermissionSetForDataSource('inventory.borrowed_inventory')->HasViewGrant() && $withDetails)
            {
            //
            // View column for inventory_borrowed_inventory detail
            //
            $column = new DetailColumn(array('Inventory_ID'), 'inventory.borrowed_inventory', 'inventory_borrowed_inventory_handler', $this->dataset, 'Borrowed Inventory');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Item_Condition_Name_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            // View column for Photo field
            //
            $column = new BlobImageViewColumn('Photo', 'Photo', 'Photo', $this->dataset, true, 'inventoryGrid_Photo_handler_list');
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Item_Condition_Name_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            // View column for Photo field
            //
            $column = new BlobImageViewColumn('Photo', 'Photo', 'Photo', $this->dataset, true, 'inventoryGrid_Photo_handler_view');
            $column->setNullLabel('No Photo');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Completeness_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            
            //
            // View column for Completeness_Photo field
            //
            $column = new BlobImageViewColumn('Completeness_Photo', 'Completeness_Photo', 'Completeness Photo', $this->dataset, true, 'inventoryGrid_Completeness_Photo_handler_view');
            $column->setNullLabel('No Photo');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Item_Description_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Remark_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editor->SetShowImage(true);
            $editor->setAcceptableFileTypes('image/*');
            $editColumn = new FileUploadingColumn('Photo', 'Photo', $editor, $this->dataset, false, false, 'inventoryGrid_Photo_handler_edit');
            $editColumn->SetFileSizeCheckMode(true, 4125696);
            $editColumn->SetImageFilter(new NullFilter());
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            ...
            $editor->SetShowImage(true);
            $editor->setAcceptableFileTypes('image/*');
            $editColumn = new FileUploadingColumn('Completeness Photo', 'Completeness_Photo', $editor, $this->dataset, false, false, 'inventoryGrid_Completeness_Photo_handler_edit');
            $editColumn->SetAllowSetToNull(true);
            $editColumn->SetFileSizeCheckMode(true, 4125696);
            $editColumn->SetImageFilter(new NullFilter());
            $editColumn->setAllowListCellEdit(false);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $editor->SetShowImage(true);
            $editor->setAcceptableFileTypes('image/*');
            $editColumn = new FileUploadingColumn('Photo', 'Photo', $editor, $this->dataset, false, false, 'inventoryGrid_Photo_handler_insert');
            $editColumn->SetFileSizeCheckMode(true, 4125696);
            $editColumn->SetImageFilter(new NullFilter());
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $this->RenderText($editColumn->GetCaption())));
            $editor->GetValidatorCollection()->AddValidator($validator);
            ...
            $editor->SetShowImage(true);
            $editor->setAcceptableFileTypes('image/*');
            $editColumn = new FileUploadingColumn('Completeness Photo', 'Completeness_Photo', $editor, $this->dataset, false, false, 'inventoryGrid_Completeness_Photo_handler_insert');
            $editColumn->SetAllowSetToNull(true);
            $editColumn->SetFileSizeCheckMode(true, 4125696);
            $editColumn->SetImageFilter(new NullFilter());
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Item_Condition_Name_handler_print');
            $grid->AddPrintColumn($column);
            ...
            // View column for Photo field
            //
            $column = new BlobImageViewColumn('Photo', 'Photo', 'Photo', $this->dataset, true, 'inventoryGrid_Photo_handler_print');
            $column->setNullLabel('No Photo');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Completeness_handler_print');
            $grid->AddPrintColumn($column);
            
            //
            // View column for Completeness_Photo field
            //
            $column = new BlobImageViewColumn('Completeness_Photo', 'Completeness_Photo', 'Completeness Photo', $this->dataset, true, 'inventoryGrid_Completeness_Photo_handler_print');
            $column->setNullLabel('No Photo');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Item_Description_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Remark_handler_print');
            $grid->AddPrintColumn($column);
        }
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Item_Condition_Name_handler_export');
            $grid->AddExportColumn($column);
            ...
            // View column for Photo field
            //
            $column = new BlobImageViewColumn('Photo', 'Photo', 'Photo', $this->dataset, true, 'inventoryGrid_Photo_handler_export');
            $column->setNullLabel('No Photo');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Completeness_handler_export');
            $grid->AddExportColumn($column);
            
            //
            // View column for Completeness_Photo field
            //
            $column = new BlobImageViewColumn('Completeness_Photo', 'Completeness_Photo', 'Completeness Photo', $this->dataset, true, 'inventoryGrid_Completeness_Photo_handler_export');
            $column->setNullLabel('No Photo');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Item_Description_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Remark_handler_export');
            $grid->AddExportColumn($column);
        }
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Item_Condition_Name_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            // View column for Photo field
            //
            $column = new BlobImageViewColumn('Photo', 'Photo', 'Photo', $this->dataset, true, 'inventoryGrid_Photo_handler_compare');
            $column->setNullLabel('No Photo');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Completeness_handler_compare');
            $grid->AddCompareColumn($column);
            
            //
            // View column for Completeness_Photo field
            //
            $column = new BlobImageViewColumn('Completeness_Photo', 'Completeness_Photo', 'Completeness Photo', $this->dataset, true, 'inventoryGrid_Completeness_Photo_handler_compare');
            $column->setNullLabel('No Photo');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Item_Description_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('inventoryGrid_Remark_handler_compare');
            $grid->AddCompareColumn($column);
        }
        ...
        protected function doRegisterHandlers() {
            $detailPage = new inventory_inventory_loans_conditionPage('inventory_inventory_loans_condition', $this, array('Inventory_ID'), array('Inventory_ID'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionSetForDataSource('inventory.inventory_loans_condition'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('inventory.inventory_loans_condition'));
            $detailPage->SetTitle('Inventory Loans Condition');
            $detailPage->SetMenuLabel('Inventory Loans Condition');
            $detailPage->SetHeader(GetPagesHeader());
            $detailPage->SetFooter(GetPagesFooter());
            $detailPage->SetHttpHandlerName('inventory_inventory_loans_condition_handler');
            $handler = new PageHTTPHandler('inventory_inventory_loans_condition_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);$detailPage = new inventory_borrowed_inventoryPage('inventory_borrowed_inventory', $this, array('Inventory_ID'), array('Inventory_ID'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionSetForDataSource('inventory.borrowed_inventory'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('inventory.borrowed_inventory'));
            $detailPage->SetTitle('Borrowed Inventory');
            $detailPage->SetMenuLabel('Borrowed Inventory');
            $detailPage->SetHeader(GetPagesHeader());
            $detailPage->SetFooter(GetPagesFooter());
            $detailPage->SetHttpHandlerName('inventory_borrowed_inventory_handler');
            $handler = new PageHTTPHandler('inventory_borrowed_inventory_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Name field
            //
            $column = new TextViewColumn('Item_Condition', 'Item_Condition_Name', 'Item Condition', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Item_Condition_Name_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Photo', 'inventoryGrid_Photo_handler_list', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Name field
            //
            $column = new TextViewColumn('Item_Condition', 'Item_Condition_Name', 'Item Condition', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Item_Condition_Name_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Photo', 'inventoryGrid_Photo_handler_print', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Completeness field
            //
            $column = new TextViewColumn('Completeness', 'Completeness', 'Completeness', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Completeness_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Completeness_Photo', 'inventoryGrid_Completeness_Photo_handler_print', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Item_Description field
            //
            $column = new TextViewColumn('Item_Description', 'Item_Description', 'Item Description', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Item_Description_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Remark field
            //
            $column = new TextViewColumn('Remark', 'Remark', 'Remark', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Remark_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Name field
            //
            $column = new TextViewColumn('Item_Condition', 'Item_Condition_Name', 'Item Condition', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Item_Condition_Name_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Photo', 'inventoryGrid_Photo_handler_compare', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Completeness field
            //
            $column = new TextViewColumn('Completeness', 'Completeness', 'Completeness', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Completeness_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Completeness_Photo', 'inventoryGrid_Completeness_Photo_handler_compare', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Item_Description field
            //
            $column = new TextViewColumn('Item_Description', 'Item_Description', 'Item Description', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Item_Description_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Remark field
            //
            $column = new TextViewColumn('Remark', 'Remark', 'Remark', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Remark_handler_compare', $column);
            ...
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Photo', 'inventoryGrid_Photo_handler_insert', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Completeness_Photo', 'inventoryGrid_Completeness_Photo_handler_insert', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
            $selectQuery = 'select distinct d.Department_ID,  
            concat(o.Awesome_Name,\' (\',d.Job_Division,\')\') as displayName
            from department as d 
            ...
            $column = new TextViewColumn('Item_Condition', 'Item_Condition_Name', 'Item Condition', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Item_Condition_Name_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Photo', 'inventoryGrid_Photo_handler_view', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Completeness field
            //
            $column = new TextViewColumn('Completeness', 'Completeness', 'Completeness', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Completeness_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Completeness_Photo', 'inventoryGrid_Completeness_Photo_handler_view', new ImageFitByHeightResizeFilter(100));
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Item_Description field
            //
            $column = new TextViewColumn('Item_Description', 'Item_Description', 'Item Description', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Item_Description_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);//
            // View column for Remark field
            //
            $column = new TextViewColumn('Remark', 'Remark', 'Remark', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'inventoryGrid_Remark_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);$selectQuery = 'select distinct d.Department_ID,  
            concat(o.Awesome_Name,\' (\',d.Job_Division,\')\') as displayName
            from department as d 
            inner join office as o 
            ...
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Photo', 'inventoryGrid_Photo_handler_edit', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);$handler = new ImageHTTPHandler($this->dataset, 'Completeness_Photo', 'inventoryGrid_Completeness_Photo_handler_edit', new NullFilter());
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new inventoryPage("inventory", "inventory.php", GetCurrentUserPermissionSetForDataSource("inventory"), 'UTF-8');
        $Page->SetTitle('Inventory');
        $Page->SetMenuLabel('Inventory');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("inventory"));
