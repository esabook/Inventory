            ...
            {foreach item=PageListPage from=$List.Pages}
                ...
                {if $PageListPage.GroupName == $GroupCaption}
                    {if $PageListPage.BeginNewGroup}
                        ...
                        <hr>
                        <div class="row pgui-home-group" style="justify-content: center;">
                    {/if}

                    <div class="col-md-6 col-sm-6 col-xs-12 pgui-home-col">
                        <div class="pgui-home-item-wrapper">
                            <div class="pgui-home-item{if $PageListPage.ClassAttribute} {$PageListPage.ClassAttribute}{/if}" style="text-align: center">
                                <a href="{$PageListPage.Href|escapeurl}" title="{$PageListPage.Hint}" style="margin-bottom: 30px">
