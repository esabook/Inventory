...
<div class="addition-block">
    <div class="btn-toolbar">
        <div class="btn-group" style="margin-left: 13px">
            <button class="btn btn-default " onclick="location.href='user.php';">
                <i class="icon-user-add"></i>
                {$Captions->GetMessageString('User')}
            </button>

            <button class="btn btn-default add-user"  onclick="location.href='user.php?operation=insert';">
